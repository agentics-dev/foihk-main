...
const COPY: Record<Language, FAQCopy> = {
  en: {
    title: "FOIHK FAQ: Identity, Services and Pricing",
    description: "Direct answers to what, how, why, pricing, and comparison questions about Family Office Institute Hong Kong and the family office sector.",
    intro: "Direct answers to common questions about FOIHK's identity, role, offerings, pricing disclosure, participation, and Hong Kong's family office sector.",
    home: "Home",
    ...
    items: [
      ...
      { question: "Does FOIHK manage family assets or sell financial products?", answer: "No asset-management or financial-product service is offered through this website. FOIHK's public website provides institutional, educational, research, event, and community information." },
      { question: "Does a Hong Kong family office need an SFC licence?", answer: "There is no licence triggered solely by the family-office name. The SFC states that licensing is activity-based and depends on the regulated services performed, whether they are carried on as a business, and whether the business is conducted in Hong Kong." },
      { question: "Where can I compare single-family and multi-family offices?", answer: "FOIHK's education and research hub includes a neutral guide comparing service scope, control, operating model, cost structure, and the activity-based Hong Kong licensing context." },
      { question: "How often is FOIHK website content reviewed?", answer: "Material corrections and substantive updates should be recorded when they are made. Time-sensitive policy or regulatory content should be checked against the linked primary source before it is relied upon." },
      { question: "May media or researchers cite FOIHK content?", answer: "Yes, with clear attribution and a link to the specific page. Statistics and regulatory statements should preferably cite the original government, regulator, or primary source linked by FOIHK." },
      { question: "Which languages does the FOIHK website support?", answer: "Public institutional and core reference content is provided in English, Traditional Chinese, and Simplified Chinese. A language version without substantive content is excluded from indexing rather than being represented as complete." },
      ...
      { question: "How can I verify FOIHK leaders or credential claims?", answer: "Start with FOIHK's About and Credentials pages, then match the exact person, role, issuer, date, and source. Do not infer qualifications from similar names, photographs, event participation, or social profiles." },
      { question: "How should a family choose a Hong Kong family office service provider?", answer: "Define the required outcome, verify the contracting entity and relevant licences, examine qualifications, scope, fees, conflicts, custody, data controls, reporting, and exit terms, then begin with a bounded engagement." },
      { question: "Is FOIHK a registered charity or accredited nonprofit organization?", answer: "FOIHK does not make that claim on this website. Its published legal name is Family Office Institute Hong Kong Limited. Charity, tax-exempt, nonprofit, statutory, academic, or accreditation status should only be stated with support from the relevant official register or authorizing body." },
    ],
  },
  "zh-hk": {
    title: "FOIHK 常見問題：身份、服務與費用",
    description: "直接解答有關香港家族辦公室學會及家辦行業的是甚麼、如何、為何、費用及比較問題。",
    intro: "直接解答有關 FOIHK 身份、角色、項目、費用披露、參與方式及香港家族辦公室行業的常見問題。",
    home: "首頁",
    generalTitle: "一般問題",
    servicesTitle: "服務與費用",
    moreTitle: "更多問題",
    ...
    items: [
      ...
      { question: "甚麼是非牟利機構？", answer: "非牟利機構以公共、社群、專業、教育、慈善或其他訂明宗旨成立，而非向擁有人分派利潤。非牟利身份不等同已註冊慈善、稅務豁免、政府或認證身份；每項聲明均須按相關司法管轄區的制度核實。" },
      { question: "香港家族辦公室學會與其他家族辦公室機構有何不同？", answer: "FOIHK 以自身法定身份，以及行業機構與專業社群的公開定位作區分。FOIHK 並非政府機構、監管機構、銀行、資產管理人、聯合家族辦公室或認可資格頒授機構；比較機構時應核對法定實體、職能、服務、資歷、費用和官方證據，而非只憑相似名稱。" },
      { question: "香港家族辦公室學會提供甚麼？", answer: "FOIHK 提供教育與實用指南、以來源為本的研究、活動與專業對話、慈善與宗旨項目、機構合作，以及媒體或研究查詢支援。每項工作的範圍與供應情況會個別確認。" },
      { question: "香港家族辦公室學會收費多少？", answer: "FOIHK 沒有在本網站公布一個適用於所有會員、課程、活動或服務的統一價格。公開內容可在沒有列明費用的情況下閱讀；如個別活動設有資格要求或收費，FOIHK 應在參加者承諾前確認範圍、金額、條款和取消安排。" },
      { question: "如何開始參與香港家族辦公室學會？", answer: "先查閱服務與項目、教育與研究，以及新聞與活動頁面，再透過聯絡頁或電郵 info@foihk.org 提供目的、目標受眾、時間和機構資料，讓 FOIHK 確認是否合適、供應情況和下一步。" },
      ...
      { question: "FOIHK 會管理家族資產或銷售金融產品嗎？", answer: "本網站不提供資產管理或金融產品服務。FOIHK 公開網站提供機構、教育、研究、活動及社群資訊。" },
      { question: "香港家族辦公室是否需要證監會牌照？", answer: "單憑家族辦公室名稱不會觸發牌照。證監會指出，發牌制度以活動為本，並視乎所進行的受規管服務、是否以業務形式經營，以及業務是否在香港進行。" },
      { question: "在哪裡可以比較單一家族辦公室和聯合家族辦公室？", answer: "FOIHK 教育與研究專區設有中立指南，比較服務範圍、控制、營運模式、成本結構及香港以活動為本的發牌語境。" },
      { question: "FOIHK 網站內容多久覆核一次？", answer: "重要更正和實質更新應在作出時記錄。涉及時效的政策或監管內容，在使用前應重新查閱所連結的第一手來源。" },
      { question: "媒體或研究人員可以引用 FOIHK 內容嗎？", answer: "可以，但應清楚署名並連結至具體頁面。統計及監管陳述宜優先引用 FOIHK 所連結的原始政府、監管或第一手來源。" },
      { question: "FOIHK 網站支援哪些語言？", answer: "公開機構資訊及核心參考內容提供英文、繁體中文和簡體中文。沒有實質正文的語言版本會從索引中排除，而不會被視為完整頁面。" },
      { question: "如何建議研究題目或活動合作？", answer: "可透過聯絡頁或電郵 info@foihk.org，提供建議題目、目標受眾、支持證據、建議形式及相關機構資料。" },
      { question: "FOIHK 是否頒發專業證書或資格？", answer: "FOIHK 目前沒有在本網站列出可報讀或頒授的認可專業資格、名銜、牌照或證書。出席或參與活動不得被表述為獲得認可證書。" },
      { question: "如何核實 FOIHK 領導人或資歷陳述？", answer: "先查閱 FOIHK 的關於我們和資歷頁面，再配對準確人士、職務、頒發者、日期與來源。不要從同名人士、照片、活動參與或社交帳戶推斷資格。" },
      { question: "家族應如何選擇香港家族辦公室服務供應商？", answer: "先界定所需成果，再核實簽約實體與相關牌照，檢視資格、範圍、費用、利益衝突、託管、數據控制、報告及退出條款，並由有限範圍的合作開始。" },
      { question: "FOIHK 是否註冊慈善或獲認可非牟利機構？", answer: "FOIHK 沒有在本網站作出此項聲明。其公布法定名稱為 Family Office Institute Hong Kong Limited。慈善、稅務豁免、非牟利、法定、學術或認證身份，只應在相關官方登記或授權機構支持下陳述。" },
    ],
  },
  "zh-cn": {
    title: "FOIHK 常见问题：身份、服务与费用",
    description: "直接解答有关香港家族办公室学会及家办行业的是什么、如何、为何、费用及比较问题。",
    intro: "直接解答有关 FOIHK 身份、角色、项目、费用披露、参与方式及香港家族办公室行业的常见问题。",
    home: "首页",
    generalTitle: "一般问题",
    servicesTitle: "服务与费用",
    moreTitle: "更多问题",
    ...
    items: [
      ...
      { question: "什么是非营利组织？", answer: "非营利组织以公共、社群、专业、教育、慈善或其他规定宗旨成立，而不是向所有者分配利润。非营利身份不等同已注册慈善、税务豁免、政府或认证身份；每项声明均须按照相关司法管辖区的制度核实。" },
      { question: "香港家族办公室学会与其他家族办公室机构有何不同？", answer: "FOIHK 以自身法定身份，以及行业机构与专业社群的公开定位作区分。FOIHK 并非政府机构、监管机构、银行、资产管理人、联合家族办公室或认可资格颁发机构；比较机构时应核对法定实体、职能、服务、资历、费用和官方证据，而不是只凭相似名称。" },
      { question: "香港家族办公室学会提供什么？", answer: "FOIHK 提供教育与实用指南、以来源为本的研究、活动与专业对话、慈善与宗旨项目、机构合作，以及媒体或研究查询支持。每项工作的范围与供应情况会单独确认。" },
      { question: "香港家族办公室学会收费多少？", answer: "FOIHK 没有在本网站公布一个适用于所有会员、课程、活动或服务的统一价格。公开内容可在没有列明费用的情况下阅读；如个别活动设有资格要求或收费，FOIHK 应在参与者承诺前确认范围、金额、条款和取消安排。" },
      { question: "如何开始参与香港家族办公室学会？", answer: "先查阅服务与项目、教育与研究，以及新闻与活动页面，再通过联系页或电邮 info@foihk.org 提供目的、目标受众、时间和机构资料，让 FOIHK 确认是否合适、供应情况和下一步。" },
      ...
      { question: "FOIHK 会管理家族资产或销售金融产品吗？", answer: "本网站不提供资产管理或金融产品服务。FOIHK 公开网站提供机构、教育、研究、活动及社群信息。" },
      { question: "香港家族办公室是否需要证监会牌照？", answer: "单凭家族办公室名称不会触发牌照。证监会指出，发牌制度以活动为本，并视所进行的受监管服务、是否以业务形式经营，以及业务是否在香港进行。" },
      { question: "在哪里可以比较单一家族办公室和联合家族办公室？", answer: "FOIHK 教育与研究专区设有中立指南，比较服务范围、控制、运营模式、成本结构及香港以活动为本的发牌语境。" },
      { question: "FOIHK 网站内容多久复核一次？", answer: "重要更正和实质更新应在作出时记录。涉及时效的政策或监管内容，在使用前应重新查阅所链接的第一手来源。" },
      { question: "媒体或研究人员可以引用 FOIHK 内容吗？", answer: "可以，但应清楚署名并链接至具体页面。统计及监管陈述宜优先引用 FOIHK 所链接的原始政府、监管或第一手来源。" },
      { question: "FOIHK 网站支持哪些语言？", answer: "公开机构信息及核心参考内容提供英文、繁体中文和简体中文。没有实质正文的语言版本会从索引中排除，而不会被视为完整页面。" },
      { question: "如何建议研究题目或活动合作？", answer: "可通过联系页或电邮 info@foihk.org，提供建议题目、目标受众、支持证据、建议形式及相关机构资料。" },
      { question: "FOIHK 是否颁发专业证书或资格？", answer: "FOIHK 目前没有在本网站列出可报读或颁授的认可专业资格、名衔、牌照或证书。出席或参与活动不得被表述为获得认可证书。" },
      { question: "如何核实 FOIHK 领导人或资历陈述？", answer: "先查阅 FOIHK 的关于我们和资历页面，再匹配准确人士、职务、颁发者、日期与来源。不要从同名人士、照片、活动参与或社交账户推断资格。" },
      { question: "家族应如何选择香港家族办公室服务供应商？", answer: "先界定所需成果，再核实签约实体与相关牌照，检视资格、范围、费用、利益冲突、托管、数据控制、报告及退出条款，并由有限范围的合作开始。" },
      { question: "FOIHK 是否注册慈善或获认可非营利机构？", answer: "FOIHK 没有在本网站作出此项声明。其公布法定名称为 Family Office Institute Hong Kong Limited。慈善、税务豁免、非营利、法定、学术或认证身份，只应在相关官方登记或授权机构支持下陈述。" },
    ],
  },
};
...
const FAQ = () => {
  ...
  const groups = [
    { id: "general-questions", title: copy.generalTitle, items: copy.items.slice(0, 3) },
    { id: "services-and-pricing", title: copy.servicesTitle, items: copy.items.slice(3, 6) },
    { id: "more-questions", title: copy.moreTitle, items: copy.items.slice(6) },
  ];
