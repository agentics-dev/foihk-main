...
const COPY: Record<Language, Copy> = {
  en: {
    ...
    secretaryRole: "Founding Secretary",
    ...
    secretaryNote: "Chan Man Ching serves as FOIHK's Founding Secretary. Her role supports the institute's governance, member communication, programme coordination, and day-to-day institutional development.",
